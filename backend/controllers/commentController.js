...
exports.createComment = async (req, res) => {
    try {
        ...
        try {
            ...
            const hateResult = await axios.post(`${mlBaseUrl}/predict/hate-rnn`, { text }, mlConfig)
            const SentimentResult = await axios.post(`${mlBaseUrl}/predict/sentiment`, { text }, mlConfig)
