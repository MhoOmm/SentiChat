...
export default function AdminDashboard() {
  ...
  if (loading) {
   ...
   // DRAFT 3 -- COLOR CHANGED
   return (
    <div className="min-h-screen bg-brand text-white font-sans">

      {/* ══════════ HEADER ══════════ */}
      <header className="sticky top-0 z-40 bg-brand/95 backdrop-blur-xl border-b border-white/10 shadow-lg px-4 md:px-6 lg:px-10 py-4">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          {/* MOBILE MENU BUTTON */}
          <button className="lg:hidden p-2 rounded-lg bg-white/10 hover:bg-white/20 transition">
          ...
          {/* NAV */}
          <nav className="flex flex-col lg:flex-row lg:items-center gap-2 bg-white/5 lg:bg-transparent p-2 lg:p-0 rounded-xl w-full lg:w-auto order-2 lg:order-1">

            <Link
              to="/admin/dashboard"
              className={`px-4 py-2.5 rounded-lg font-medium text-sm transition-all duration-200 ${
                activeTab === "dashboard"
                  ? "bg-blue-300 text-brand shadow-md"
          ...
          {/* PROFILE */}
          <div className="flex items-center space-x-3 flex-shrink-0 order-3">
            {admin && (
              <div className="relative">
                <div 
                  className="w-11 h-11 bg-white text-brand rounded-full flex items-center justify-center font-semibold text-lg cursor-pointer 
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 mt-3 w-52 bg-white text-gray-900 rounded-xl shadow-2xl border border-gray-200 py-2 z-50">
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-red-600 hover:bg-red-50 font-medium text-sm transition"
                    >
                      Logout
                    </button>
                  </div>
      ...
      <main className="p-4 md:p-8 lg:p-10 max-w-7xl mx-auto">
        ...
        {/* DASHBOARD CARD */}
        <div className="bg-white/10 backdrop-blur-xl p-6 md:p-8 rounded-2xl shadow-xl border border-white/10 min-h-[400px]">
          ...
          {/* TEAM AREA */}
          <div className="mt-6 p-8 border-2 border-dashed border-white/20 rounded-xl text-center text-white/60">
            <h3 className="text-lg font-semibold mb-2 text-white">
              Team Collaboration Area
            </h3>
            <p className="text-sm">KANISHK</p>
          </div>
